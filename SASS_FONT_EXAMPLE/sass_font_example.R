##  Rstudio example:
## REF: <https://gallery.shinyapps.io/sass-font/>


## PURPOSE:  shiny app, using sass and colourpicker
## Requires: sass-font.scss placed in same directory
...
ui <- fluidPage(
  headerPanel("Sass Font Example REF: Rstudio"),
  uiOutput("sass"),
