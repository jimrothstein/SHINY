...
format: 
  html
#    code-tools: 
#      source: https://github.com/quarto-dev/quarto-web/tree/main/docs/interactive/shiny/_examples/old-faithful/sh#iny-old-faithful.qmd
server: shiny
---
<!--
...
```{r}
#| context: server
output$table  <- renderTable({faithful[,2]})
